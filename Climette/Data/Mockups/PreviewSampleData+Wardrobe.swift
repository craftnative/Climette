    ...
    public static func seedWardrobeData(into context: ModelContext) {
        ...
        let mockGarments: [ClothingItemEntity] = [
            ...
            ClothingItemEntity(
                ...
                layerRaw: nil,
                styleCategoryRaw: GarmentStyleCategory.pants.rawValue,
                baseThermal: 4,
                baseWind: 4,
                baseWater: 1,
            ...
            ClothingItemEntity(
                archetypeId: "arch_bot_skirt_midi_denim",
                canonicalName: "Falda midi denim",
                bodyZoneRaw: BodyZone.lowerBody.rawValue,
                layerRaw: nil,
                styleCategoryRaw: GarmentStyleCategory.skirt.rawValue,
                baseThermal: 3,
                baseWind: 2,
                baseWater: 1,
                userNickname: "Falda Vaquera",
                color: "Denim Medio",
                isAvailable: true
            ),
